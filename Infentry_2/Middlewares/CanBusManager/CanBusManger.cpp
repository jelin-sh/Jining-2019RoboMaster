...
/**CAN1总线要监听的ID Port列表**/
u16 CanRxIDList[CAN_ID_LIST_SIZE] = {
        CAN_ID_CHASSIS1,
        CAN_ID_CHASSIS2,
        CAN_ID_CHASSIS3,
        CAN_ID_CHASSIS4,
...
void CanBusManger::Init()
{
  ...
  for(int i = 0;i<8;i++)
  {
    canPortList->add(new CanPort(CanRxIDList[i]));
  }
...
//  if(id == CAN_ID_HODERYAW)
//  {
//    for(int i = 0;i<8;i++)
//    {
//      System::pc::printf("0x%02x ",rxBuf[i]);
//    }
//    System::pc::printf("id:0x%02x\r\n",id);
//  }
