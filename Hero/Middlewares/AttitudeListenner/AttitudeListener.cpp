...
void AttitudeListener::Init() {
  ...
  auto *attitudeThread = new MyThread("attitudeThread", 512, osPriorityNormal,
                                      AttitudeListenerTask, nullptr);
  attitudeThread->Run();
}
...
bool AttitudeListener::IsBusy() { return busy; }
...
//        if(fabs(wz) > 10)
//        {
//          System::pc::println("Yaw:%d ",wz); /*YAW���ٶ�*/
//        }
        if(fabs(wx) > 100)
        {
